                ...
                <div class="container">
                    <div class="columns is-vcentered is-multiline">
                        <div class="column is-three-quarters">
                            <span class="tag is-warning is-medium"><i class="fas fa-star"></i>&nbsp;Honorary Mention</span>
                            <h1 class="title">Evee</h1>
                            <p class="subtitle">Web development basics</p>
                            ...
                            <span class="tag is-info is-medium">Handlebars</span>
                            <span class="tag is-info is-medium">Mapbox</span>
                            <span class="tag is-info is-medium">Cloudinary</span>
                            <span class="tag is-info is-medium">Passport</span>
                        </div>
                        <div class="column is-full">
                            <img class="box-image" src="/prin-evee.png" alt="Yucaterco-principal" />
                        </div>
                    </div>
                    ...
                    <div class="columns">
                            <div class="column">
                                <img class="box-image" src="/2-evee.png" alt="Yucaterco-principal" />    
                            </div>
                            <div class="column">
                                <img class="box-image" src="/3-yuca.png" alt="Yucaterco-principal" />    
                            </div>
                            <div class="column">
                                <img class="box-image" src="/1-evee.png" alt="Yucaterco-principal" />    
                            </div>
                        </div>
                </div>
            </section>
