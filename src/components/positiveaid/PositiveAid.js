                ...
                <div className="container">
                    <div className="columns is-centered is-vcentered">
                        ...
                        <div className="column">
                            ...
                            <p className="subtitle">
                                (+)aid is a project developed in 10 days: presented as final exam of the final module of Ironhack's Full Time Web Development Bootcamp, and subsequently the next day on Ironhack's Hackshow.<br /><br />
                                ...
                                With this project I was chosen one of the three winners of the final module, and presented it on Ironhack's Hackshow.
                            </p>
